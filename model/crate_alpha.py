...
# state_dict = torch.load('/HDD_data_storage_2u_1/jinruiyang/shared_space/code/SCLIP/clip/converted_checkpoints/crate_alpha_B16.pth')
# model = CRATE_base()
